    ...
    return (
        <div className="manual">
            ...
            <div className="manual-section" id="upload-image">
                ...
                <ol>
                    <li>清楚給予商品類別名稱，例如: 水瓶。</li>
                    <li>選擇投放定向，點擊"選擇投放定向"下拉選單。</li>
                    <li>點擊"選擇圖片"按鈕並選擇您要上傳的去背商品圖。</li>
                    <li>上傳去背商品圖後須等待約40秒。</li>
                </ol>
            </div>
            <div className="manual-section" id="generate-images">
                <h3>生成圖片</h3>
                <p>系統將透過AIGC得到多尺寸廣告素材，這些素材將瞄準欲投放之受眾來生成。</p>
                <ul>
                    <li>按下"生成圖片與文案"需等待約30秒。</li>
                </ul>
            </div>
            <div className="manual-section" id="view-history">
                ...
                <ul>
                    <li>每個專案都會顯示產品名稱、產品描述、定向描述、產品圖片和生成的圖片。</li>
                </ul>
            </div>
